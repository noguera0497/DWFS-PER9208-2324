...
function redConverter() {
    ...
    // Recorre cada fila de píxeles en la imagen.
    for (let i = 0; i < pixels.length; i++) {
        // Recorre cada píxel en la fila actual.
        for (let j = 0; j < pixels[i].length; j++) {
            // Establece el componente verde del píxel actual en 0.
            pixels[i][j][1] = 0;
            // Establece el componente azul del píxel actual en 0.
            pixels[i][j][2] = 0;
        }
    }
...
function greyConverter() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        ...
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            // Calculamos la media
            const calc = (pixels[i][j][0] + pixels[i][j][1] + pixels[i][j][2]) / 3
...
function blackAndWhiteConverter() {
    ...
    for (let i = 0; i < pixels.length; i++) {
        ...
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            // Calculamos la media
            let calc = (pixels[i][j][0] + pixels[i][j][1] + pixels[i][j][2]) / 3
...
function scaleDown() {
    ...
    handler.savePixels(reduced, outputPath, handler.getShape()[0] / 2, handler.getShape()[1] / 2);
}
...
function dimBrightness(dimFactor) {
    ...
    for (let i = 0; i < pixels.length; i++) {
        ...
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            pixels[i][j][0] = pixels[i][j][0]/10;
            pixels[i][j][1] = pixels[i][j][1]/10;
            pixels[i][j][2] = pixels[i][j][2]/10;
        }
    }
...
function merge(alphaFirst, alphaSecond) {
    ...
    for (let i = 0; i < catPixels.length; i++) {
        ...
        for (let j = 0; j < catPixels[i].length; j++) {
            ...
            pixel.push((catPixels[i][j][0] * alphaFirst) +  (0.2 *  dogPixels[i][j][0] * alphaSecond))
            pixel.push((catPixels[i][j][1] * alphaFirst) +  (0.2 *  dogPixels[i][j][1] * alphaSecond))
            pixel.push((catPixels[i][j][2] * alphaFirst) +  (0.2 *  dogPixels[i][j][2] * alphaSecond))
