...
function redConverter() {
  let outputPath = 'output/galapagos_red.jpg';
...
function greenConverter() {
  let outputPath = 'output/galapagos_green.jpg';
  let pixels = handler.getPixels();
...
function blueConverter() {
  let outputPath = 'output/galapagos_blue.jpg';
  let pixels = handler.getPixels();
...
function greyConverter() {
  let outputPath = 'output/galapagos_grey.jpg';
  let pixels = handler.getPixels();
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
        ...
        pixels[i][j] = [grayValue, grayValue, grayValue];
    }
  }
...
function blackAndWhiteConverter() {
  let outputPath = 'output/galapagos_black_and_white.jpg';
  let pixels = handler.getPixels();
 ...
 */
function scaleDown() {
  let outputPath = 'output/galapagos_scale_down.jpg';
  let pixels = handler.getPixels();
  let pixelsEscala = [];
...
function dimBrightness(dimFactor) {
  let outputPath = 'output/galapagos_dimed.jpg';
  let pixels = handler.getPixels();
...
function invertColors() {
  let outputPath = 'output/galapagos_inverse.jpg';
  let pixels = handler.getPixels();
...
function merge(alphaFirst, alphaSecond) {
  let catHandler = new ImageHandler('input/dog.jpg');
