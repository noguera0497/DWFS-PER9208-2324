...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i = 0 ; i < catPixels.length ; i++){
    ...
    for (let j = 0; j < catPixels[i].length; j++) {
      pixels[i].push([])
      pixels[i][j].push((catPixels[i][j][0] * alphaFirst) + (dogPixels[i][j][0] * alphaSecond)) 
      pixels[i][j].push((catPixels[i][j][1] * alphaFirst) + (dogPixels[i][j][1] * alphaSecond))
      pixels[i][j].push((catPixels[i][j][2] * alphaFirst) + (dogPixels[i][j][2] * alphaSecond))
    }
  }
